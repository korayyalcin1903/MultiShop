...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class StatisticsController : Controller
    {
        ...
        public StatisticsController(ICatalogStatisticService catalogStatisticService, IUserStatisticService userStatisticService, ICommentService commentService, IDiscountStatisticService discountStatisticService, IMessageStatisticService messageStatisticService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.getProductCount = getUserCount;
